...
import com.devpedrod.springboot_mongodb.resource.util.URL;
import com.devpedrod.springboot_mongodb.service.PostService;
...
public class PostResource {
	...
	public ResponseEntity<List<Post>> fullSearch(
		...
		List<Post> listPosts = service.fullSearch(text, min, max);
		return ResponseEntity.ok().body(listPosts);
	}
